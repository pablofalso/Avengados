...
class Agua(Escena):
    def __init__(self, director):
        ...
        plataforma = Plataforma(pygame.Rect(500, 200, 100, 5),100,5)
        plataformaSuelo = Plataforma(pygame.Rect(300, 400, 1000, 5),1000,5)

        # y el grupo con las mismas
        self.grupoPlataformas = pygame.sprite.Group(plataforma, plataformaSuelo)

        # Creamos un grupo con los Sprites que se mueven
        #  En este caso, solo los personajes, pero podría haber más (proyectiles, etc.)
        self.grupoSpritesDinamicos = pygame.sprite.Group(self.jugador1)
        # Creamos otro grupo con todos los Sprites
        self.grupoSprites = pygame.sprite.Group(self.jugador1, plataforma, plataformaSuelo)
